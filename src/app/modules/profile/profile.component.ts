...
import { CustomerDto } from '../../shared/models/user.model';
  ...
  update() {
    if (this.verifyUserInput()) {
      ...
      const updateModel: UpdateUserModel = {
        ...
        DefaultCountryId:1, //this.user.DefaultCountryId,
        PreferredCurrencyId:1, //:this.user.PreferredCurrencyId,
        PreferredLanguageId:1, //this.user.PreferredLanguage.id
      };
